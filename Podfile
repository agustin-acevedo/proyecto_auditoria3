...
def wordpress_kit
  ...
  pod 'WordPressKit', git: 'https://github.com/wordpress-mobile/WordPressKit-iOS.git', commit: '1686c487103840e66ba0a6b7556d733eb5b2898e'
...
abstract_target 'Apps' do
  ...
  pod 'WordPressAuthenticator', '~> 9.0', '>= 9.0.4'
